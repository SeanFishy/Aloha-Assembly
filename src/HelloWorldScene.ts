...
export default class HelloWorldScene extends Phaser.Scene {
	...
	preload() {
		...
		this.load.image('hole','assets/black-hole.png')
	}
	...
	create() {
		...
		this.holes.create(100,350,'hole')
		this.holes.create(600,500,'hole')
		this.holes.create(50,50,'hole')
		this.holes.create(750,50,'hole')
		this.holes.create(700,300,'hole')
		this.physics.add.collider(this.player,this.holes,this.handleHitHoles, undefined, this)
	}

	private handleHitHoles(player: Phaser.GameObjects.GameObject, h: Phaser.GameObjects.GameObject){
		this.physics.pause()
